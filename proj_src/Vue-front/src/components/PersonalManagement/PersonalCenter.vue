  ...
  <el-container style="height: 100%; background: white">
      ...
      <el-form :inline="true" :rules="rules" :model="ruleForm" ref="ruleForm" class="demo-form-inline" >
        <el-row > 
          ...
          <el-col :span="24" :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <div style="text-align:center">
          <el-form-item label="工号 " prop="username" label-width="150px">
                <el-input
                disabled
                style="width:500px ;"
                  placeholder="请输入工号"
      ...
      <div style="text-align:center">
      <el-form-item label="组号 " prop="classes" label-width="150px">
            <el-input
    ...
    <el-col :span="24" :xs="24" :sm="24" :md="24" :lg="24" :xl="24" >
    <div style="text-align:center">
    <el-form-item label="部门 " prop="dept" label-width="150px" v-show="selectNoLeader">
          <el-input
          style="width:500px ;"
            placeholder="请输入部门"
